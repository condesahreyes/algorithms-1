...
void pruebasListaPosIntNoAcotada(Prueba* pruebaConcreta)
{
	...
	borrar(l2, 50); //borro más alla de la posición - no deberia tener efecto
	...
	borrar(l2, 0); //Borro una vez que la lista ya esta vacia, no debería tener efecto
	...
	borrar(l, 4);
	borrar(l, 1);
	borrar(l, 50); //Borro mucho más alla de la ultima posición
